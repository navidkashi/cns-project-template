...
conv_connection = TorchConvolutionalConnection(input_layer, conv_layer, kernel_size=26, stride=1, padding=False,
                                               learning_rule=FlatSTDP, lr=[0.001, 0.001], weight_decay=0, wmax=2,
...
net = Network(learning=True, dt=dt, decision=WinnerTakeAllDecision, kwta=7, inhibition_radius=0)
...
fig.show()
fig.savefig('fashion_7', bbox_inches='tight')
